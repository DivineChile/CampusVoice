const steps = [
  {
    ...
    description:
      "Sign up with your student credentials. Your identity is never linked to your feedback.",
  },
  {
    number: "02",
    title: "Submit Your Feedback",
    description:
      "Choose a category and describe your experience — academics, facilities, admin, or anything else.",
  },
  {
    number: "03",
    title: "Drive Real Change",
    description:
      "Administrators review anonymised feedback and take action to improve your campus experience.",
  },
];
